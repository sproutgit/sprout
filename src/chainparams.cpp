...
static Checkpoints::MapCheckpoints mapCheckpoints =
    ...
    (500, uint256("0x45335194146e79c1a94444d9b7fb5d32f424b760ffa4bbdbd4f2eb560c015b73"))
...
public:
    CMainParams()
    {
        ...
        nMinerThreads = 0;
        nTargetTimespan = 1 * 60; // Sprout: 1 day
        nTargetSpacing = 2 * 60;  // Sprout: 2 minutes
        nMaturity = 10;
        ...
        nLastPOWBlock = 400;
        nModifierUpdateBlock = 1; // we use the version 2 for SPROUT
        ...
        // DNS Seeding
        vSeeds.push_back(CDNSSeedData("sproutcoin.co", "dnsseed1.sproutcoin.co"));
        vSeeds.push_back(CDNSSeedData("sproutcoin.co", "dnsseed2.sproutcoin.co"));
        vSeeds.push_back(CDNSSeedData("31.184.255.90", "31.184.255.90"));
        vSeeds.push_back(CDNSSeedData("188.68.210.41", "188.68.210.41"));

        // Sprout addresses start with 'S'
        base58Prefixes[PUBKEY_ADDRESS] = std::vector<unsigned char>(1, 63);
        // Sprout script addresses start with '9'
        base58Prefixes[SCRIPT_ADDRESS] = std::vector<unsigned char>(1, 20);
        // Sprout private keys start with '9' or 'A'
        base58Prefixes[SECRET_KEY] = std::vector<unsigned char>(1, 22);
        // Sprout BIP32 pubkeys start with 'xpub' (Bitcoin defaults)
        base58Prefixes[EXT_PUBLIC_KEY] = boost::assign::list_of(0x04)(0x88)(0xB2)(0x1E).convert_to_container<std::vector<unsigned char> >();
        // Sprout BIP32 prvkeys start with 'xprv' (Bitcoin defaults)
        base58Prefixes[EXT_SECRET_KEY] = boost::assign::list_of(0x04)(0x88)(0xAD)(0xE4).convert_to_container<std::vector<unsigned char> >();
        // Sprout BIP44 coin type is '981' (0x800003d5)
...
public:
    CTestNetParams()
    {
        ...
        nMinerThreads = 0;
        nTargetTimespan = 1 * 60; // Sprout: 1 day
        nTargetSpacing = 2 * 60;  // Sprout: 1 minute
        nLastPOWBlock = 400;
        nMaturity = 15;
        ...
        // Testnet Sprout addresses start with 'n'
        base58Prefixes[PUBKEY_ADDRESS] = std::vector<unsigned char>(1, 112);
        // Testnet Sprout script addresses start with '5'
        base58Prefixes[SCRIPT_ADDRESS] = std::vector<unsigned char>(1, 10);
        // Testnet private keys start with '5' or 'n' (Bitcoin defaults)
        base58Prefixes[SECRET_KEY] = std::vector<unsigned char>(1, 240);
        // Testnet Sprout BIP32 pubkeys start with 'tpub' (Bitcoin defaults)
        base58Prefixes[EXT_PUBLIC_KEY] = boost::assign::list_of(0x04)(0x35)(0x87)(0xCF).convert_to_container<std::vector<unsigned char> >();
        // Testnet Sprout BIP32 prvkeys start with 'tprv' (Bitcoin defaults)
        base58Prefixes[EXT_SECRET_KEY] = boost::assign::list_of(0x04)(0x35)(0x83)(0x94).convert_to_container<std::vector<unsigned char> >();
        // Testnet sprout BIP44 coin type is '1' (All coin's testnet default)
...
public:
    CRegTestParams()
    {
        ...
        nToCheckBlockUpgradeMajority = 1000;
        nMinerThreads = 1;
        nTargetTimespan = 24 * 60 * 60; // Sprout: 1 day
        nTargetSpacing = 2 * 60;        // Sprout: 1 minutes
        bnProofOfWorkLimit = ~uint256(0) >> 1;
