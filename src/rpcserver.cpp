...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* Sprout features */
        {"sprout", "masternode", &masternode, true, true, false},
        {"sprout", "listmasternodes", &listmasternodes, true, true, false},
        {"sprout", "getmasternodecount", &getmasternodecount, true, true, false},
        {"sprout", "masternodeconnect", &masternodeconnect, true, true, false},
        {"sprout", "masternodecurrent", &masternodecurrent, true, true, false},
        {"sprout", "masternodedebug", &masternodedebug, true, true, false},
        {"sprout", "startmasternode", &startmasternode, true, true, false},
        {"sprout", "createmasternodekey", &createmasternodekey, true, true, false},
        {"sprout", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"sprout", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"sprout", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"sprout", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"sprout", "getmasternodescores", &getmasternodescores, true, true, false},
        {"sprout", "mnbudget", &mnbudget, true, true, false},
        {"sprout", "preparebudget", &preparebudget, true, true, false},
        {"sprout", "submitbudget", &submitbudget, true, true, false},
        {"sprout", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"sprout", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"sprout", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"sprout", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"sprout", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"sprout", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"sprout", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"sprout", "checkbudgets", &checkbudgets, true, true, false},
        {"sprout", "mnsync", &mnsync, true, true, false},
        {"sprout", "spork", &spork, true, true, false},
#ifdef ENABLE_WALLET
...
{
    return "> sprout-cli " + methodname + " " + args + "\n";
}
