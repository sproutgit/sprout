...
BOOST_AUTO_TEST_CASE(netbase_splithost)
{
    ...
    BOOST_CHECK(TestSplitHost("127.0.0.1:41066", "127.0.0.1", 41066));
    BOOST_CHECK(TestSplitHost("[127.0.0.1]", "127.0.0.1", -1));
    BOOST_CHECK(TestSplitHost("[127.0.0.1]:41066", "127.0.0.1", 41066));
    BOOST_CHECK(TestSplitHost("::ffff:127.0.0.1", "::ffff:127.0.0.1", -1));
    BOOST_CHECK(TestSplitHost("[::ffff:127.0.0.1]:41066", "::ffff:127.0.0.1", 41066));
    BOOST_CHECK(TestSplitHost("[::]:41066", "::", 41066));
    BOOST_CHECK(TestSplitHost("::41066", "::41066", -1));
    BOOST_CHECK(TestSplitHost(":41066", "", 41066));
    BOOST_CHECK(TestSplitHost("[]:41066", "", 41066));
...
BOOST_AUTO_TEST_CASE(netbase_lookupnumeric)
{
    ...
    BOOST_CHECK(TestParse("127.0.0.1:41066", "127.0.0.1:41066"));
    BOOST_CHECK(TestParse("::ffff:127.0.0.1", "127.0.0.1:65535"));
    BOOST_CHECK(TestParse("::", "[::]:65535"));
    BOOST_CHECK(TestParse("[::]:41066", "[::]:41066"));
    BOOST_CHECK(TestParse("[127.0.0.1]", "127.0.0.1:65535"));
...
BOOST_AUTO_TEST_CASE(subnet_test)
{
    ...
    // All-Matching IPv6 Matches sprouttrary IPv4 and IPv6
