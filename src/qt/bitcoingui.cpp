                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("Sprout Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a SPROUT address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and sprout: URIs)"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About Sprout Core"), this);
    aboutAction->setStatusTip(tr("Show information about Sprout Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for Sprout"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your SPROUT addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified SPROUT addresses"));
    ...
    openAction->setStatusTip(tr("Open a sprout: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the Sprout Core help message to get a list with possible Sprout command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("Sprout Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Sprout network", "", count));
}
...
{
    QString strTitle = tr("Sprout Core"); // default title
