...
/** Utility functions used by the Sprout Qt UI.
 */
namespace GUIUtil
{
...
// Render SPROUT addresses in monospace font
...
// Parse "sprout:" URI into recipient object, return true on successful parsing
