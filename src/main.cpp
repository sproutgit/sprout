...
#if defined(NDEBUG)
#error "Sprout cannot be compiled without assertions."
#endif
...
/** Fees smaller than this (in usprout) are considered zero fee (for relaying and mining)
...
void CheckForkWarningConditionsOnNewFork(CBlockIndex* pindexNewForkTip)
{
    ...
    // We use 7 blocks rather sprouttrarily as it represents just under 10% of sustained network
...
bool static ProcessMessage(CNode* pfrom, string strCommand, CDataStream& vRecv, int64_t nTimeReceived)
{
    ...
    if (strCommand == "version") {
        ...
        // SPROUT: We use certain sporks during IBD, so check to see if they are
